...
export interface Message { id: string; conversationId: string; senderId: string; text: string; createdAt: string; receipt: Receipt; attachment?: Attachment; replyTo?: string; deleted?: boolean }
